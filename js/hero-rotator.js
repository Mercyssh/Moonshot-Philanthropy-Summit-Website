import { EFFECTS, HERO_IMAGES_DESKTOP } from "./config.js";
...
// The shape acts as a window onto the desktop HERO_IMAGES pool (config.js).
...
const ROTATOR_MASK_IMAGES = HERO_IMAGES_DESKTOP;
